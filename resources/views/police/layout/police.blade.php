...
@section('content')
    <div class="side-bar pt-5">
        ...
        <div class="category-wrapper">
            ...
            <ul class="sub-category">
                <a href="{{ route("police.loss-report.create") }}"><li><ion-icon class="mr-2" name="add-outline"></ion-icon> Add</li></a>
                <a href="{{ route("police.loss-report.index") }}"><li><ion-icon class="mr-2" name="eye-outline"></ion-icon> View</li></a>
            </ul>
        </div>
